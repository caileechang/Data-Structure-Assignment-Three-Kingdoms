...
public class BF2_SoldiersArrangement {
    ...
    public static void main(String[] args) {
        ...
        printGenerals(sortedByLeadership, "leadership");

        // Call selectionSort to sort the generals by strength
        General[] sortedByStrength = selectionSortStrength(generalsArray);
        System.out.println("Generals sorted by strength: ");
        printGenerals(sortedByStrength, "strength");
        ...
        printGenerals(sortedByIntelligence, "intelligence");
        ...
        printGenerals(sortedByPoliticalSkill, "political skill");
        ...
        printGenerals(sortedByHitPoints, "hit points");
        ...
        printGenerals(sortedByAbility, "ability");
    ...
    public static General[] selectionSortStrength(General[] array) {
        int n = array.length;
        for (int i = 0; i < n - 1; i++) {
            int minIndex = i;
            for (int j = i + 1; j < n; j++) {
                if (array[j].getStrength() < array[minIndex].getStrength()) {
                    minIndex = j;
                }
            }
            General temp = array[minIndex];
    ...
    public static void printGenerals(General[] generals, String ability) {
        if (ability.equalsIgnoreCase("leadership")) {
            for (General general : generals) {
                System.out.printf("%-15s%-15s\n", general.getName(), general.getLeadership());
            }
        }
        else if (ability.equalsIgnoreCase("strength")) {
            for (General general : generals) {
                System.out.printf("%-15s%-15s\n", general.getName(), general.getStrength());
            }
        }
        else if (ability.equalsIgnoreCase("intelligence")) {
            for (General general : generals) {
                System.out.printf("%-15s%-15s\n", general.getName(), general.getIntelligence());
            }
        }
        else if (ability.equalsIgnoreCase("political skill")) {
            for (General general : generals) {
                System.out.printf("%-15s%-15s\n", general.getName(), general.getPoliticalSkills());
            }
        }
        else if (ability.equalsIgnoreCase("hit points")) {
            for (General general : generals) {
                System.out.printf("%-15s%-15s\n", general.getName(), general.getHitPoints());
            }
        }
        else if (ability.equalsIgnoreCase("ability")) {
            for (General general : generals) {
                System.out.printf("%-15s%-15s\n", general.getName(), general.getAbility());
            }
        }
        System.out.println("");
    }
